...
public class FaqTest {
    ...
    public static Object[][] testTextQuestions() {
        return new Object[][]{
    ...
    public void menuFAQTest() {
        ...
        objMainPage.setCloseCookiePanel(); //закрыли куки

        objMainPage.clickButtonQuestion(index);
        objMainPage.getTextButtonQuestion(index);
